<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Edit Partner" subtitle="Perbarui informasi partner yang sudah ada"
        ...
        <div class="bg-white overflow-hidden shadow-lg sm:rounded-xl border border-gray-200">
            <div class="px-8 py-6 border-b border-gray-200 bg-gradient-to-r from-indigo-50 to-purple-50">
                <h3 class="text-lg font-semibold text-gray-800">
                    ...
                    Edit Informasi Partner
                </h3>
                <p class="text-gray-600 text-xs md:text-sm mt-1">
                    Silakan perbarui detail partner Anda di bawah ini.
                </p>
            </div>
            <div class="p-8">
                <form method="POST" action="{{ route('partners.update', $partner->id) }}" enctype="multipart/form-data"
                    ...
                    <div class="space-y-2">
                        ...
                        <x-text-input id="name"
                            ...
                            type="text" name="name" :value="old('name', $partner->name)" required autofocus
                    ...
                    <x-ckeditor name="description" label="Deskripsi" :optional="false"
                        placeholder="Deskripsikan layanan anda..." :value="old('description', $partner->description)" />

                    <div class="space-y-2">
                        <x-image-upload id="logo" name="logo" label="Logo/Icon Partner" :optional="true"
                            recommended="400 x 300 px untuk hasil terbaik" :value="$partner->logo" />
                    </div>
