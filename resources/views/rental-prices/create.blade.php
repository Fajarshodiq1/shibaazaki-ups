<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Buat Harga Rental Baru" subtitle="Tambahkan harga rental untuk produk Anda"
        ...
        <main class="bg-white overflow-hidden shadow-lg sm:rounded-xl border border-gray-200">
            <div class="px-8 py-6 border-b border-gray-200 bg-gradient-to-r from-indigo-50 to-purple-50">
                <h3 class="text-lg font-semibold text-gray-800">
                    <i class="fas fa-price-tag text-indigo-500"></i>
                    Informasi Harga Rental
                </h3>
                <p class="text-gray-600 text-sm mt-1">
                    Silakan isi detail di bawah ini untuk menambahkan harga rental baru.
                </p>
            </div>

            <div class="p-8">
                <form method="POST" action="{{ route('rental-prices.store') }}" class="space-y-8" id="rentalPriceForm">
                    @csrf
                    ...
                    <section class="space-y-2">
                        ...
                        <x-select name="product_id" :options="$products->pluck('name', 'id')->toArray()" selected="{{ old('product_id') }}"
                        ...
                        <div class="flex items-center space-x-2 text-sm text-gray-500">
                            ...
                            <span>
                                Pilih produk yang akan diberikan harga rental
                            </span>
                        </div>
                    </section>
                    ...
                    <section class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <h4 class="text-blue-800 font-medium mb-2">Catatan Penting:</h4>
                                <ul class="text-blue-700 text-sm space-y-1">
                                    <li>• Setiap kombinasi produk dan durasi hanya boleh ada satu harga</li>
                                    <li>• Harga yang dimasukkan akan ditampilkan kepada customer</li>
                                    <li>• Pastikan harga sudah sesuai dengan strategi pricing Anda</li>
                                </ul>
                            </div>
                        </div>
                    </section>
