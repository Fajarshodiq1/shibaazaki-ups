<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Sewa Produk" subtitle="Kelola dan atur harga sewa" button-route="rental-prices.create"
            button-text="Tambah" />
    </x-slot>
    <main class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <section class="bg-white overflow-hidden shadow-xl sm:rounded-xl border border-gray-100">
                <x-data-table :data="$rentalPrices" :columns="[
                    [
                        'label' => 'Product',
                        'field' => 'product.name',
                        'type' => 'text',
